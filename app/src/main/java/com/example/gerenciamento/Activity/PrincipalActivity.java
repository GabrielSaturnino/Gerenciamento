...
import com.example.gerenciamento.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Gerenciamento Pessoal");
    ...
    public void excluirMovimentacao(final RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setPositiveButton("Confirmar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                atualizarSaldo();
                Toast.makeText(PrincipalActivity.this, "Item Apagado", Toast.LENGTH_LONG).show();
            }
        });
    ...
    if( movimentacao.getTipo().equals("r") ){
        ...
        usuarioRef.child("saldoTotal").setValue(receitaTotal);
    ...
    public  void recuperarResumo(){
        ...
        valueEventListenerUsuario = usuarioRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                receitaTotal = usuario.getSaldoTotal();
